...
class YoubotArm:
    ...
    _result=youbot_retrieve_msr.msg.graspblockResult()

    # Constructor.

    def __init__(self):
        self._as = actionlib.SimpleActionServer('graspObject', youbot_retrieve_msr.msg.graspblockAction, execute_cb=self.execute_cb, auto_start=False)
        self._as.start()
